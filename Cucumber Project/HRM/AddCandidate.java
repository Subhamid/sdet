...
public class AddCandidate extends BaseClass {
	...
	public void navAddRec() throws Throwable {
		...
		// fill in details
		driver.findElement(By.cssSelector("input#addCandidate_firstName")).sendKeys("Suseela");
		driver.findElement(By.cssSelector("input#addCandidate_lastName")).sendKeys("Bhamidipati"+rand);
		driver.findElement(By.cssSelector("input#addCandidate_email")).sendKeys("subhamid@gmail.com");
