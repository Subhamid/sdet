...
Feature: CRM Site
  ...
  Scenario: Create leads using parameterization
    ...
    Then Fill the details "Mrs. ", First Name "Suseela", Last Name "Bhamidipati"
    Then Navigate to View Leads page to see results "Mrs. ", First Name "Suseela", Last Name "Bhamidipati"
    And Close the Browser
